...
public class SensorQueriesTemperature extends QueryNumSingleValue<SensorDescTemperature> {
	...
	public SensorQueriesTemperature(long timestamp_from, long timestamp_to, File file) {
