...
public class SensorDescConnectivity extends SensorDescVectorValue {
	...
	public SensorDescConnectivity(final long timestamp, final boolean isConnected, final int networkType,
			final boolean isRoaming, String wifiHashId, int wifiStrength, String mobileHashId) {
		super(timestamp);
