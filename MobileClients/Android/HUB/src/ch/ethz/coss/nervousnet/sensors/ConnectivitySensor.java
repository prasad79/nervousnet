...
public class ConnectivitySensor {
	...
	public void dataReady(long timestamp, boolean isConnected, int networkType, boolean isRoaming, String wifiHashId,
			int wifiStrength, String mobileHashId) {
		listenerMutex.lock();
		for (ConnectivityListener listener : listenerList) {
			listener.connectivitySensorDataReady(timestamp, isConnected, networkType, isRoaming, wifiHashId,
	...
	public class ConnectivityTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			dataReady(System.currentTimeMillis(), isConnected, networkType, isRoaming, wifiHashId, wifiStrength,
					mobileHashBuilder.toString());
			return null;
		}
	}
