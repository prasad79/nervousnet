...
public class SensorDescBLEBeacon extends SensorDesc {
	...
	public SensorDescBLEBeacon(long timestamp, int rssi, long mac, long advertisementMSB, long advertisementLSB,
			long bleuuidMSB, long bleuuidLSB, int major, int minor, int txpower) {
		super(timestamp);
		this.rssi = rssi;
		this.mac = mac;
