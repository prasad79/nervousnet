...
public class BLESensor {
	...
	public class BLETask extends AsyncTask<Long, Void, Void> {
		...
		private final BluetoothGattCallback gattCallback = new BluetoothGattCallback() {
			...
			@Override
			public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristics,
					int status) {
			}
		...
		private void scanLeDevice(long duration) {
			// Even though this is deprecated, the BluetoothLe functionality
			// requires minSdk 21, which is Android 5.0
