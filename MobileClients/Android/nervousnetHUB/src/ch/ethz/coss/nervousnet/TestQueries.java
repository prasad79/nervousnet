...
//
	public TestQueries(Context context) {
...
//			ArrayList<BatteryData> battlist = new ArrayList<BatteryData>();
...
//			e.add((float) 60);
//
//			ArrayList<BatteryData> battdesc = batt.getTimeRange(battlist, s, e);
