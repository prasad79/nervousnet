...
public class UIConstants {
	...
	static String[] sensorNames = { "Accelerometer", "Battery", "BLEBeacon", "Connectivity", "Gyroscope", "Humidity", "Light",
	...
	static long[] sensorIds = {Constants.SENSOR_ACCELEROMETER, Constants.SENSOR_BATTERY, Constants.SENSOR_BLEBEACON,
