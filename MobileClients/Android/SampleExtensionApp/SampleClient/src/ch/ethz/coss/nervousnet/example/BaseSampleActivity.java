...
public abstract class BaseSampleActivity extends FragmentActivity {
	...
	void initConnection() {
		 ...
		 Log.d("AccelFragment", "Inside initConnection");
		mServiceConnection = new ServiceConnection() {

			
			@Override
			public void onServiceDisconnected(ComponentName name) {
				 Log.d("AccelFragment", "Inside onServiceDisconnected 2");
			...
			public void onServiceConnected(ComponentName name, IBinder service) {
				System.out.println("onServiceConnected");
				 ...
				 Log.d("AccelFragment", "Inside onServiceConnected 2");
				// TODO Auto-generated method stub
...
//				}
	...
	Runnable m_statusChecker = new Runnable() {
		...
		public void run() {
			 ...
			 Log.d("AccelFragment", "before updating");
	...
	protected void update() {
		try {
     Log.d("AccelFragment", "Inside update - "+fragment.type);
